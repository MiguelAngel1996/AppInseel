...
import 'package:tecnicos_inseel/views/pages/diagnostico_inicial.dart';

class MotivoServicio extends StatefulWidget {
  const MotivoServicio({super.key});

  @override
  State<MotivoServicio> createState() => _MotivoServicioState();
}

class _MotivoServicioState extends State<MotivoServicio> {
  @override
              ...
              child: SizedBox(
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    onChanged: (value) {
                      nuevaOt.motivo = value.replaceAll('\n', ' -').replaceAll(RegExp(r'\s+'), ' ').trim();
                    },
                  ),
                ),
              ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const DiagnosticoInicial()));
        },
        tooltip: 'Siguiente',
